...
const Hero = () => {
  return (
    <>
      <div className="md:flex items-end px-6 bg-[#E4E4E4] justify-between  py-10 md:px-16">
        <div className="md:text-8xl ww text-6xl ">
          <h1 className="">Turning heads</h1>

          <h1 className="">and conquering</h1>
        ...
        <div>
          <h1 className="md:w-80 md:text-xl mt-10 md:mt-0 w">
            NiceAtNoon is een boutique design studio gespecialiseerd in branding
            en webdesign.
          </h1>
          <button className="btn bg-white after:bg-black transition-all duration-300">
            Bekijik projecten <IoIosArrowRoundForward size={30} />
          </button>
        </div>
      </div>
    </>
