    ...
    <div>
      <div className="py-10">
        <div className=" text-center relative">
          ...
          <h1 className="www text-5xl md:text-9xl uppercase">
            Brands just want
          </h1>
          <h1 className="www text-5xl md:text-9xl uppercase">To have fun</h1>
          <div className="py-4 px-7 spin h-20 w-20 md:h-40 md:w-40 flex justify-center items-center rounded-full bg-[#20CD85] absolute md:bottom-0 -rotate-12 right-[14%]  text-xl">
            <svg
